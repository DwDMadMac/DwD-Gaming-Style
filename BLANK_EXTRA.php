            ...
            <xen:if is="{$user.customFields.profileCoverImage}">
                <img src="{$user.customFields.profileCoverImage}" style="max-width: 100%;max-height: 80%;min-height: 80%;min-width: 100%;" />
            <xen:else />
                <img src="http://downwithdestruction.net/theme/img/ConceptBackgroundA.jpg" style="max-width: 100%;max-height: 80%;min-height: 80%;min-width: 100%;" />
            </xen:if>
