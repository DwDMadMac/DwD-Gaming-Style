<?php
/**
 *      This file is part of Steam Authentication for XenForo Modified for GTA Online By DwD_MadMac
 *
...
class GTAOnline_Listener {
	public static function loadClassController($class, array &$extend) {
		switch($class) {
			case 'XenForo_ControllerPublic_Register':
				$extend[] = 'GTAOnline_ControllerPublic_Register';
				break;
			case 'XenForo_ControllerPublic_Account':
				$extend[] = 'GTAOnline_ControllerPublic_Account';
				break;
		}
	}
