...
<li id="conversation-{$conversation.conversation_id}" style="background: none !important;" class="discussionListItem {xen:if {$conversation.isNew}, 'unread'}" data-author="{$conversation.username}">
