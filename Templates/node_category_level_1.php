...
<xen:require css="node_category.css" />
    <li class="node category level_{$level} node_{$category.node_id} <xen:if is="in_array({$category.node_id}, array(94,95,96,97,98,137))">col-md-6</xen:if>" id="{xen:helper linktitle, $category.node_id, $category.title, 1}">
        <a href="{xen:link categories, $category}" class="nodeCatLink">
